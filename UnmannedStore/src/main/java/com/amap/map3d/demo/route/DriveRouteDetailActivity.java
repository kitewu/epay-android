...
import com.xbw.unman.GPSNaviActivity;
	...
	private void init() {
		...
		btn.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				mIntent.setClass(DriveRouteDetailActivity.this, GPSNaviActivity.class);
				DriveRouteDetailActivity.this.startActivity(mIntent);
			}
		});
