...
import com.xbw.scancode.scanner.AmbientLightManager;
import com.xbw.scancode.scanner.BeepManager;
...
public class SaoYiSao extends Activity implements SurfaceHolder.Callback,
        OnClickListener {
    private static final String TAG = SaoYiSao.class.getSimpleName();
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case PARSE_BARCODE_SUC: // 解析图片成功
                    ...
                    mIntent.putExtra("describe", msg.obj.toString());
                    activityReference.get().setResult(1001, mIntent);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SaoYiSao.context = getApplicationContext();
